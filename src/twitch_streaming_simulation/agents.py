...
class Citizen(EpsteinAgent):
    ...
    def __init__(
        self, model, regime_legitimacy, threshold, vision, arrest_prob_constant,iq,identity
    ):
        """
        ...
        self.state = CitizenState.SPAMBOT_QUIET
        self.vision = vision
    ...
    def step(self):
        ...
        if ((self.grievance - net_risk) > self.threshold):
            ...
            if(self.identity==0):
                ...
                self.state = CitizenState.AUDIENCE_QUIET
...
class Cop(EpsteinAgent):
    ...
    def __init__(self, model, vision, max_jail_term,iq):
        """
        Create a new Cop.
        Args:
            x, y: Grid coordinates
